...
it("未发布交付没有本地文件时不暗示文件等待送达", async () => {
  ...
  await page
    .getByTestId("import-files")
    .setInputFiles(
      "docs/superpowers/specs/camctl/examples/client-protocol/03-obtain-partial/status-report-1-7b785ee3d38af0ea04a1b546cc21204ae119eccff83757e297d7b8b2d28b0b2c.json",
    );
