...
export async function makeMediaFixture(directory:string) {
  ...
  const report=JSON.parse(await readFile('docs/superpowers/specs/camctl/examples/client-protocol/01-success/status-report-1-6a2d8346b79be33790f613d183707116fb16ec40908850b7e9963195bf4f9b62.json','utf8'));
