...
export const CAMERA_ACTION_TYPES: readonly CameraActionType[] = schema.$defs.camera_action_type.enum as CameraActionType[];
export const ACTION_TYPES: readonly ActionType[] = [...CAMERA_ACTION_TYPES, ...schema.$defs.action_type.anyOf[1].enum!] as ActionType[];
